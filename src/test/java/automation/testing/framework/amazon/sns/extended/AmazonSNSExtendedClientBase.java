...
abstract class AmazonSNSExtendedClientBase implements AmazonSNS {
  ...
  public void setEndpoint(String var1) {
    throw new AmazonClientException("Not implementing this method");
  }
  ...
  public AddPermissionResult addPermission(
      String string, String string1, List<String> list, List<String> list1) {
  ...
  public GetPlatformApplicationAttributesResult getPlatformApplicationAttributes(
    ...
    return amazonSnsToBeExtended.getPlatformApplicationAttributes(
  ...
  public ListEndpointsByPlatformApplicationResult listEndpointsByPlatformApplication(
    ...
    return amazonSnsToBeExtended.listEndpointsByPlatformApplication(
  ...
  public SetPlatformApplicationAttributesResult setPlatformApplicationAttributes(
    ...
    return amazonSnsToBeExtended.setPlatformApplicationAttributes(
